...
st.set_page_config(page_title="Historical Data Explorer", page_icon="📜", layout="wide")
...
with tab_eras:
    ...
    with col_e1:
        ...
        st.plotly_chart(fig_avg_ct, use_container_width=True)
    with col_e2:
        ...
        st.plotly_chart(fig_rr_era, use_container_width=True)
    ...
    if sel_term_dd >= 1953:
        ...
        if dd_cases_data:
            ...
            with col_dd_pie:
                ...
                st.plotly_chart(fig_dd_pie, use_container_width=True)
            with col_dd_tbl:
