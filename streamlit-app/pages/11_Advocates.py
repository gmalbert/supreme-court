...
st.set_page_config(page_title="Advocates Hub", page_icon="⚖️", layout="wide")
        ...
        if not adv_rows_data:
            ...
            with sub_issue:
                ...
                if issue_adv_rows:
                    ...
                    st.plotly_chart(fig_ia_adv, use_container_width=True)
...
with tab_amicus:
    ...
    with sub_overview_am:
        ...
        with col_left_am:
            ...
            st.plotly_chart(fig_am_total, use_container_width=True)
        with col_right_am:
            ...
            fig_am_wr.update_layout(title="Win Rate by Amicus Filer",height=420,xaxis_tickangle=-40,
                                     ...
                                     plot_bgcolor="white",paper_bgcolor="white")
            st.plotly_chart(fig_am_wr, use_container_width=True)
    ...
    with sub_cats_am:
        ...
        st.plotly_chart(fig_cat_am, use_container_width=True)
...
with tab_oral:
    ...
    with sub_live:
        ...
        if live_cases:
            live_case_names = [c.get("name","") for c in live_cases]
